...
We now specifically list all functions used in the analysis inthe text of the manuscript.
...
We have added an empirical example. The reviewer may be left unsatisfied, as it is not one that shows a difference in using the PRC. Nonetheless, we think the empirical example is more to show what sort of things one can do with the PRC, and that the relative value of the method is better shown in the simulations.
