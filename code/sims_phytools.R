...
x<-1:10*5
plot(x, t1Standard,  type="l", ylim=c(0, 0.5), lwd=2, xlab="Tree size", ylab="Type 1 error rate")
...
legend("topleft", lwd=2, col=c("black", "black", "black", "grey", "grey"), legend=c("Standard", "IC", "IC Perm", "IC rank test", "IC sign test"), lty=c(1, 2,3, 1, 2))
...
x<-1:10*5
plot(x, t1Standard,  type="l", ylim=c(0, 1), lwd=2, xlab="Tree size", ylab="Type 1 error rate")
lines(c(1, 100), c(0.05, 0.05), col="red")
lines(x, t1Contrasts, lwd=2, col="black", lty=2)
lines(x, t1ContrastsPerm, lwd=2, col="black", lty=3)
lines(x, t1Rank, lwd=2, col="grey")
